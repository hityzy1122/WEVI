...
from models.baseModule import BaseNet, Correlation, conv
...
class PWCDCNet(BaseNet):
    ...
    def warp(self, x, flo):
        ...
        output = F.grid_sample(x, vgrid, 'bilinear', align_corners=True)
        mask = torch.ones(x.size()).cuda()
        mask = F.grid_sample(mask, vgrid, 'bilinear', align_corners=True)
